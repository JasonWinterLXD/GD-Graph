...
class MedicalGraph:
    ...
    def read_nodes(self):
        ...
        foods, producers, symptoms, disease_infos, chinese_medicine = [], [], [], [], []
        # 定义关系类型列表
        ...
        rels_acompany, rels_category, rels_chinese_medicine = [], [], []
        ...
        with open(self.data_path) as f:
            for data in f:
                ...
                if 'chinese_medicine' in data_json:
                    chinese_medicine.append(data_json['chinese_medicine'])
                    # rels_chinese_medicine.append([[disease, t] for t in data_json['chinese_medicine']])
                    rels_chinese_medicine.append([disease, data_json['chinese_medicine']])
        ...
        return (set(drugs), set(foods), set(checks), set(departments), set(producers), 
                set(symptoms), set(diseases), set(chinese_medicine), disease_infos, rels_check, rels_recommandeat,
                rels_noteat, rels_doeat, rels_department, rels_commonddrug, rels_drug_producer, 
                rels_recommanddrug, rels_symptom, rels_acompany, rels_category, rels_chinese_medicine)
    ...
    def create_graphnodes(self):
        ...
        Drugs, Foods, Checks, Departments, Producers, Symptoms, Diseases, ChineseMedicine, disease_infos = nodes_data[:9]
        self.create_diseases_nodes(disease_infos)
        for label, nodes in [('Drug', Drugs), ('Food', Foods), ('Check', Checks), 
                           ('Department', Departments), ('Producer', Producers), ('Symptom', Symptoms), ('ChineseMedicine', ChineseMedicine)]:
    ...
    def create_graphrels(self):
        ...
        rel_configs = [
            ...
            ('Disease', 'ChineseMedicine', rels_data[11], 'chinese_medicine_cure', '中医治疗')
        ]
